...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/var/www/gbbm/project/log/backend_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/var/www/gbbm/project/cache/backend/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/var/www/gbbm/project/apps/backend/i18n',
));
...
'database' => $this->getDatabaseManager()->getDatabase('doctrine'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/var/www/gbbm/project/cache/backend/dev/template',
  'lifetime' => 86400,
  'prefix' => '/var/www/gbbm/project/apps/backend/template',
)));
